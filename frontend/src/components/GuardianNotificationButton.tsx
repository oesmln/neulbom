...
/** Bell access stays in each guardian header after alerts leave the tab bar. */
...
const styles = StyleSheet.create({
  ...
  dot: { position: "absolute", top: 1, right: 2, width: 8, height: 8, borderRadius: 4, backgroundColor: colors.destructive, borderWidth: 1, borderColor: guardian.blue },
});
